...
func (c *ConcordanceMMS) ReadIntoStruct(record []string) error {
	// layout := "1/2/2006"
	layout := "20060102"
...
func (c *ConcordanceMMS) IsValidForInclusion() bool {
	return c.ContractNumber != ""
}

func (c *ConcordanceMMS) GetRebateAmount() float64 {
	return c.ExtendedRebate
}

func (c *ConcordanceMMS) GetEmptyModel() interface{} {
	return c
}
